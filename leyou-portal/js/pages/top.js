const lyTop = {
                        ...
                        <div class='search'> \
                            <form action='' class='sui-form form-inline'> \
                                ...
                                <div class='input-append'> \
                                    <input type='text'  onkeydown=\"if(event.keyCode===13){event.keyCode=0;event.returnValue=false;}\" id='autocomplete'  @keyup.enter='search' v-model='key' \
    ...
    methods: {
        search() {
            window.location = window.location.origin + '/search.html?key=' + this.key;
        },
