 ...
 */
public class TuPianZhiJiaProcess implements PageProcessor {

    static final String baseUrl = "https://www.tupianzj.com/" ;

    static int count = 0;
    //爬取深度
    static int webDepth = 5;

    public static void main(String[] args) {
        Spider.create(new TuPianZhiJiaProcess())
                .addUrl(baseUrl + "meinv/yishu/list_178_1.html")
//                .addPipeline(new JsonFilePipeline("D:\\webmagic\\"))
    ...
    private void processLinks(Page page) {
        ...
        for (String preprocessUrl : preprocessUrlList) {
            ...
            jpgTotalUrl = baseUrl + jpgTotalUrl;
